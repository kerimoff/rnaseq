...
Have look at the [issue tracker for our repo](https://github.com/czbiohub/rnaseq/issues). Maybe someone has already had the same problem?

Gitter is a chatt client connected to Github, feel free to come in and chat with us;
[nfcore/rnaseq Gitter]((https://gitter.im/czbiohub/rnaseq))
